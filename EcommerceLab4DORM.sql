...
-- '1','BOOKS','Train Your Brain','780'
-- '2','GAMES','GTA V','1450'
-- '3','GROCERIES','OATS','99'
-- '3','GROCERIES','MILK','99'
-- '4','ELECTRONICS','ROG LAPTOP','529'
-- '4','ELECTRONICS','Boat Earphones','529'
...
-- Output
-- '1','Rajesh Retails','2.1250','Average Service'
-- '2','Appario Ltd.','3.3333','Average Service'
-- '3','Knome products','5.0000','Excellent Service'
-- '4','Bansal Retails','4.0000','Average Service'
-- '5','Mittal Ltd.','2.0000','Poor Service'
...
create procedure proc()
	begin
		select supplier.supp_ID, supplier.supp_name, t4.rating,
			...
			from supplier
			inner join (
				select t3.supp_ID, avg(t3.rat_ratstars) as rating
				from(
					select t2.rat_ratstars, supplier_pricing.supp_ID
					from supplier_pricing
					inner join(
						select t1.rat_ratstars, orders.pricing_ID
							from orders
							inner join(
								select ord_ID, rat_ratstars
								from rating) as t1
